...
const SearchBooks = () => {
  ...
  // Set up the mutation hook to save a book
  ...
  // create function to handle saving a book to our database using the mutation
  const handleSaveBook = async (bookId: string) => {
    ...
    if (!token) {
      setErrorMessage('You must be logged in to save books.');
      return false;
    }
